...
<form method="post" action="meetingSelectUpdatePro.do"
name="meetingSelectUpdateForm">
<input type="hidden" name="meeting_num" value="${mdto.meeting_num }">
<table border="1">
	<tr>
		<th>아이디</th>
		<td style="width: 300">
			<input type="text" name="id" value="${mdto.id }"  style="width: 200" readonly>
		</td>
	</tr>
	<tr>	
		<th>타이틀</th>
		<td>
			<input type="text" name="meeting_title" value="${mdto.meeting_title }" style="width: 200">
		</td>
	</tr>
	<tr>
		<th>미팅 지역</th>
